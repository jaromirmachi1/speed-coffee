      ...
      <Container>
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-8">
          <div>
            ...
            <p className="text-base md:text-lg font-sans text-dark leading-relaxed mb-6">
        ...
        <div className="text-center">
          <p className="text-base md:text-lg font-sans text-dark mb-4">
            Book us for your next event
          </p>
          <a
            href="#contact"
            className="inline-block px-8 py-3 bg-beige border-2 border-dark rounded-full font-sans font-medium text-dark hover:bg-dark hover:text-beige transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-dark focus:ring-offset-2"
          >
            here
          </a>
        </div>
