...
export const LanguageProvider = ({ children }: LanguageProviderProps) => {
  ...
  const translations = {
    en: {
      ...
      "about.description": "SPEED COFFEE SHOP IS A MOBILE CAFE WITH SOUL THAT TRAVELS ALL AROUND THE CZECH REPUBLIC. YOU CAN FIND US AT VARIOUS EVENTS, CORPORATE GATHERINGS, WEDDINGS, AND SPECIAL OCCASIONS WHERE WE BRING HIGH-QUALITY COFFEE AND MATCHA DIRECTLY TO YOU.",
